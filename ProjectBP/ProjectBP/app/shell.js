define(['plugins/router'], function (router) {
    return {
        ...
        activate: function () {
            //return
            router.map([
                { route: ['', 'home'],           moduleId: 'hello/index',      title: 'Hello World', nav: false, },
                { route: 'personnel',            moduleId: 'personnel/index',  title: 'BP\'s CRUD',  nav: 2 },
                { route: 'personnel/person/:id',      moduleId: 'personnel/person', title: 'Edit', hash: '#personnel/person/:id' }
